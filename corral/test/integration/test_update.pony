...
class  \nodoc\ TestUpdateLocalDirect is UnitTest
  ...
  fun name(): String =>
    "integration/update/local-direct"
    ...
    Execute(
      ...
      =>
        try
          ...
          let repos_dir =
            data.dir_path("_repos")?
          h.assert_false(repos_dir.exists())

          let corral_dir =
            data.dir_path("_corral")?
          h.assert_false(
            corral_dir.exists())
...
class  \nodoc\ TestUpdateMutuallyRecursive
  is UnitTest
  var data: (DataClone | DataNone) = DataNone

  fun name(): String =>
    "integration/update/mutually-recursive"

  fun ref set_up(h: TestHelper val) ? =>
    data =
      DataClone(h, "mutually-recursive")?
...
class  \nodoc\ TestUpdateSelfReferential
  is UnitTest
  var data: (DataClone | DataNone) = DataNone

  fun name(): String =>
    "integration/update/self-referential"

  fun ref set_up(h: TestHelper val) ? =>
    data =
      DataClone(h, "self-referential")?
...
class  \nodoc\ TestUpdateGithubDeep is UnitTest
  ...
  fun name(): String =>
    "integration/update/github-deep"
...
class  \nodoc\ TestUpdateRemoteGits is UnitTest
  ...
  fun name(): String =>
    "integration/update/remote-gits"
...
class  \nodoc\ TestUpdateBadGitReference
  is UnitTest
  var data: (DataClone | DataNone) = DataNone

  fun name(): String =>
    "integration/update/bad-git-reference"

  fun ref set_up(h: TestHelper val) ? =>
    data =
      DataClone(h, "bad-git-reference")?
