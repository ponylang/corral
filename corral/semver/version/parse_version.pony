...
primitive ParseVersion
  """
  Parses a semantic version string into a Version.
  """
  fun apply(s: String): Version =>
    """
    Parse `s` and return a Version. Parsing errors are
    collected in the returned Version's `errors` array.
    """
    let v = Version(0)
