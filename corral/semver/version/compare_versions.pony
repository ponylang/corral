...
primitive CompareVersions
  """
  Compares two Versions according to semantic versioning
  precedence rules.
  """
  fun apply(
    v1: Version box,
  ...
  =>
    """
    Return Less, Equal, or Greater based on semver
    precedence of `v1` relative to `v2`.
    """
    let heads =
      [ (v1.major, v2.major)
        (v1.minor, v2.minor)
