"""
The version package provides semantic version parsing,
...
class Version is
  (ComparableMixin[Version] & Hashable & Stringable)
  """
  A semantic version with major, minor, and patch
  components, optional pre-release fields, and optional
  build metadata fields.
  """
  var major: U64 = 0
  var minor: U64 = 0
  var patch: U64 = 0
  let pr_fields: Array[PreReleaseField] =
    Array[PreReleaseField]
  let build_fields: Array[String] =
    Array[String]
  ...
  new create(
    ...
    minor': U64 = 0,
    patch': U64 = 0,
    pr_fields': Array[PreReleaseField] =
      Array[PreReleaseField],
    build_fields': Array[String] =
      Array[String]
  ) =>
    major = major'
    minor = minor'
    ...
    errors.append(
      ValidateFields(pr_fields, build_fields))
  ...
  fun string(): String iso^ =>
    // we always need at least 5 chars ("0.0.0")
